...
from tobiiresearch.implementation.Calibration import (
    CALIBRATION_STATUS_FAILURE, CALIBRATION_STATUS_SUCCESS,
    CALIBRATION_STATUS_SUCCESS_LEFT_EYE, CALIBRATION_STATUS_SUCCESS_RIGHT_EYE,
    VALIDITY_INVALID_AND_NOT_USED, VALIDITY_VALID_AND_USED,
    VALIDITY_VALID_BUT_NOT_USED, _calibration_status)
from tobiiresearch.implementation.EyeTracker import (
    CAPABILITY_CAN_DO_SCREEN_BASED_CALIBRATION, EyeTracker)
