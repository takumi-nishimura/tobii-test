...
from tobiiresearch.implementation.EyeOpennessData import EyeOpennessData
...
from tobiiresearch.implementation.Notifications import (
    CalibrationChangedData, CalibrationModeEnteredData,
    CalibrationModeLeftData, ConnectionLostData, ConnectionRestoredData,
    DeviceFaultsData, DeviceWarningsData, DisplayAreaChangedData,
    EyeTrackingModeChangedData, GazeOutputFrequencyChangedData,
    TrackBoxChangedData)
from tobiiresearch.implementation.StreamErrorData import StreamErrorData
from tobiiresearch.implementation.TimeSynchronizationData import \
    TimeSynchronizationData
from tobiiresearch.implementation.UserPositionGuide import UserPositionGuide
...
##
# Indicates that the device can deliver a HMD eye openness data stream.
#
# Value in tuple EyeTracker.device_capabilities
# <CodeExample>create_eyetracker.py</CodeExample>
CAPABILITY_HAS_EYE_OPENNESS_DATA = "capability_has_eye_openness_data"
...
# Used in EyeTracker.subscribe_to and EyeTracker.unsubscribe_from for gaze data.
#
# Callbacks will receive a UserPositionGuide, object or a dictionary with values if as_dictionary is True.
# See @ref find_all_eyetrackers or EyeTracker.__init__ on how to create an EyeTracker object.
# <CodeExample>user_position_guide.py</CodeExample>
...
##
# Used in EyeTracker.subscribe_to and EyeTracker.unsubscribe_from for eye openness data.
#
# You will get a callback when time synchronized eye openness is received. Time synchronized eye openness is not supported 
# on all eye trackers, other eye trackers need additional license to activate this support. Callbacks will receive 
# a EyeOpennessData object or a dictionary with values if as_dictionary is True.
# See @ref find_all_eyetrackers or EyeTracker.__init__ on how to create an EyeTracker object.
# <CodeExample>eye_openness_data.py</CodeExample>
EYETRACKER_EYE_OPENNESS_DATA = "eyetracker_eye_openness_data"
...
_subscription_types = {EYETRACKER_GAZE_DATA:
                       ...
                       {"type_index": 9,
                        "stream_name": "eye openness data",
                        "data_class": EyeOpennessData}
                       }
