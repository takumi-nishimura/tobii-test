...
from tobiiresearch.implementation.Errors import (
    EyeTrackerOperationFailedError, _on_error_raise_exception)
from tobiiresearch.implementation.HMDLensConfiguration import \
...
class TobiiProEyeTrackerData(object):
    def __init__(self, dictionary):
        ...
        self.runtime_version = dictionary["runtime_version"]
